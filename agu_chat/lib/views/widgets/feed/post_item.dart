...
class PostItem extends StatelessWidget {
  ...
  Widget buildCategoryPost(){
    ...
    switch(post.category){
      case 0:
        widget = const Text('Post', style: TextStyle(color: Colors.white, fontSize: fontSize));
        break;
      case 1:
        widget = const Text('Game', style: TextStyle(color: Colors.white, fontSize: fontSize));
        break;
      case 2:
        widget = const Text('Foto/Video', style: TextStyle(color: Colors.white, fontSize: fontSize));
        break;
      default:
